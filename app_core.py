...
/* Sidebar: fixed and visible above splash/video */
...
/* Desktop: push content to the right to make room for sidebar */
...
/* Keep app containers transparent so video shows through */
html, body,
[data-testid="stAppViewContainer"],
[data-testid="stApp"],
[data-testid="stBody"],
...
/* Dark mode: translucent overlay so video remains visible */
[data-testid="stAppViewContainer"] { background-color: rgba(10,10,10,0.35) !important; color: #e0e0e0 !important; }
...
/* Video sits under content but above page background */
